...
public class LoginScreen {	
	...
	public void verifyApiForLoginScreen() {		
		...
		try {
			...
			assertTrue(jsonpath.getString("aadharNumber").equals("1234"),"Not Expected aadharNumber'"+jsonpath.getString("aadharNumber")+"'");
			assertTrue(jsonpath.getString("userName").equals("akshata"),"Not Expected username'"+jsonpath.getString("username")+"'");
